...
class Network(object):
    def __init__(self):
        ...
        self.model_path = '/opt/carla-simulator/PythonAPI/examples/agent_model'
        ...
        try:
            ...
            self.model_path_full = '/opt/carla-simulator/PythonAPI/examples/agent_model/model_background_X_1.h5'
    ...
    def angle_predict(self,img):
        try:
            ...
            self.predict_angle = float(self.model.predict(img,batch_size = 1))
